...
function getForecast(coords, ciudad, callback) {
    let lat = coords[0]
    let lon = coords[1]
    ...
    request(options, function(err, res, body) {
        ...
        let json = getForecastJson(ciudad, body.currently.summary, body.currently.temperature, body.currently.precipProbability)
...
function getForecastJson(ciudad, summary, temp, precipPro) {
    return {"location": ciudad, "weather": `${summary}. Actualmente esta a ${temp}°C. Hay ${precipPro*100}% de posibilidad de lluvia.`}
}
